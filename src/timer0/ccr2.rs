...
impl W {}
#[doc = "TIMER capture/compare register 2, Address\n\nYou can [`read`](crate::Reg::read) this register and get [`ccr2::R`](R). You can [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ccr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Ccr2Spec;
